...
if ($_POST['submit']) {
	...
	$sql = 
		"-- --------------------------------------------------------\n".
		"-- MOVIES DATABASE BACKUP\n".
		"-- DATE : ".date('d m Y',NOW)."\n".
		"-- Created by demdaysao.net\n".
		"-- --------------------------------------------------------\n\n";
	...
	echo "<form method=post>".
		"<input class=checkbox type=checkbox name=export_structure value=1 checked> Backup structure<br>".
		"<input class=checkbox type=checkbox name=export_data value=1 checked> Backup database<br>".
		"<input class=checkbox type=checkbox name=drop_table value=1 checked> Add DROP TABLE IF EXISTS<br>".
