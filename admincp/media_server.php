...
if ($mode == 'change') {
	...
	*/
	...
	<table cellspacing="0" width="90%" class=border>
		<tr><td colspan=2 align=center class=title><b>Config movie server</b></td></tr>
		<?php /*
		...
		<tr><td class=fr>Movies folder :</td><td class=fr_2><input name="s_folder" size="32" value="<?=$server_folder?>"></td></tr>
		<tr><td class=fr>Link movies host :</td><td class=fr_2><input name="s_url" size="50" value="<?=$server_url?>"></td></tr>
		<tr><td colspan="2" align="center" class=fr><input type="submit" value="Change server" name=submit class=submit></td></tr>
		<tr><td colspan=2>
		Your movie link is like that : http://link_host_chua_movie/folder_movie/link_movie.wmv<br>
		You have to upload link_movie.wmv to folder_movie<br>
		Now in here, Play movie link : <b><?=$server_url?>/<?=$server_folder?>/link_movie.wmv</b>
		</td></tr>
	</td></tr>
	</table>
	</form>
