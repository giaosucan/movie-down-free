...
function InnovaEditorUtil()
  ...
  for(var i=0;i<oScripts.length;i++)
    ...
    if(sSrc.indexOf("editor/editor.js")!=-1) this.scriptPath=oScripts[i].src.replace(/editor.js/ig,"");
    }
...
function InnovaEditor(oName)
  ...
  for(var i=0;i<oScripts.length;i++)
    {
    var sSrc=oScripts[i].src.toLowerCase();
    if(sSrc.indexOf("editor/editor.js")!=-1) this.scriptPath=oScripts[i].src.replace(/editor.js/,"");
    }
  ...
  this.btnSave=true;this.btnPreview=true;this.btnFullScreen=true;this.btnPrint=true;this.btnSearch=true;
  this.btnSpellCheck=true;this.btnTextFormatting=true;
  this.btnListFormatting=true;this.btnBoxFormatting=true;this.btnParagraphFormatting=true;this.btnCssText=true;this.btnCssBuilder=true;
  this.btnStyles=true;this.btnParagraph=true;this.btnFontName=true;this.btnFontSize=true;
  ...
  this.btnStrikethrough=true;this.btnSuperscript=true;this.btnSubscript=true;
  ...
  this.btnLTR=true;this.btnRTL=true;this.btnForeColor=true;this.btnBackColor=true;
  this.btnHyperlink=true;this.btnBookmark=true;this.btnCharacters=true;this.btnCustomTag=true;
  ...
  this.btnHTMLFullSource=true;this.btnHTMLSource=true;
  this.btnXHTMLFullSource=true;this.btnXHTMLSource=true;
