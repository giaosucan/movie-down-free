...
if ($_POST['rating'] && $_POST['media_id'] && $_POST['star']) {
	...
	if (!$isLoggedIn && m_get_config('must_login_to_rate')) echo "<br>&nbsp; &nbsp; Have to login !";
}
?>